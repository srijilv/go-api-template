...
import (
	...
	externalRef1 "github.com/srijilv/go-api-template.git/pkg/interfaces/openapi/list_books"
)
...
func NewListBooksRequest(server string, params *ListBooksParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/learning/books")
	if operationPath[0] == '/' {
...
type ListBooksResponse struct {
	...
	JSON200      *externalRef1.ListBooksResponse
...
func ParseListBooksResponse(rsp *http.Response) (*ListBooksResponse, error) {
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest externalRef1.ListBooksResponse
